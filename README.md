...
| 平台 | 版本 | 文件 |
| --- | --- | --- |
| Android | **1.1.1** | [`app-release.apk`](https://github.com/costr1024/costr/releases/download/v1.1.1/app-release.apk)（≈72 MB，universal APK，含 arm64/arm/x86_64/x64 全 ABI） |

> 当前为正式版（v1.1.1）。Android 包 `applicationId = com.costr.costr`，用正式
