...
// tag). kind30000DisplayName must prefer `name` and fall back to `d`, and
...
void main() {
  group('kind30000DisplayName', () {
    ...
    test('Costr list: falls back to d when no name tag', () {
      ...
      expect(kind30000DisplayName(e), 'friends');
    });
    ...
    test('default list (d="") is null — excluded from named groups', () {
      ...
      expect(kind30000DisplayName(e), isNull);
    });
